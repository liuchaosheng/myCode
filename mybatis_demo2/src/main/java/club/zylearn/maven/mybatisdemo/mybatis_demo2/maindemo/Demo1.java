package club.zylearn.maven.mybatisdemo.mybatis_demo2.maindemo;

import java.util.List;

import club.zylearn.maven.mybatisdemo.mybatis_demo2.dao.IPersonDAO;
import club.zylearn.maven.mybatisdemo.mybatis_demo2.factory.MyLocalSqlSessionFactory;
